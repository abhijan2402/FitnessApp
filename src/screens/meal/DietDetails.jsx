...
function DietDetails(props) {
  ...
  useEffect(() => {
    ...
    setMealDetails({
      ...
      steps: convertStepToArray(details?.meal?.steps),
      ingredients: convertIngrediantsToArray(
        details?.meal?.required_ingredients,
      ),
      nutrient: convertNutrientsToArray(details?.meal?.nutritions),
    });
  }, []);
  ...
  return (
    <GestureHandlerRootView style={{flex: 1}}>
      <ScrollView>
        ...
        <BottomSheet
          ref={bottomSheetRef}
          extraRequiredHeight={viewHeight}
          style={{}}>
          <View style={styles.detailContainer} onLayout={getViewHeight}>
            ...
            <SolidContainer containerStyle={styles.solidcontainer}>
              ...
              <SmallText
                style={{
                  ...
                  flexGrow: 1,
                  textAlign: 'right',
                }}>{`${mealDetails.ingredients.length} items`}</SmallText>
            </SolidContainer>
            <FlatList
            ...
            {meal?.user_picked || meal?.user_skip ? (
