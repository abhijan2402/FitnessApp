...
const Profile = () => {
    ...
    return (
        <View style={styles.Container}>
            ...
            <ScrollView>
                <ProfileTop name="Stefani Wong" Program={"Lose a Fat Program"} />
                <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-around", margin: 20 }}>
                    <ProfileDesc value={"180"} vauleOf={"Height"} unit={"cm"} />
                    <ProfileDesc value={"100"} vauleOf={"Weight"} unit={"kg"} />
                    <ProfileDesc value={"10"} vauleOf={"Age"} unit={"yo"} />
                </View>
