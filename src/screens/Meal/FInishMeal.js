    ...
    return (
        <View style={{ width: width, height: height, backgroundColor: "white" }}>
            ...
            <View style={{ alignItems: "center", marginTop: "10%" }}>
                <TextH4 style={{ textAlign: "center" }}>Congratulations, You Have Finished Your Meal</TextH4>
                <SmallText style={{ width: "80%", textAlign: "center", marginTop: 7 }}>Please Upload the Photos
                </SmallText>
                {/* <SmallText style={{ width: "80%", textAlign: "center", marginTop: 7, }}>-Jack Lalanne</SmallText> */}
            </View>
            <View style={{ alignItems: "center", marginTop: "30%" }}>
                <PrimaryButton containerStyle={{ width: width - 30, }} title={'Back To Home'} onPress={() => navigation.navigate(SCREENS.MEALHOME)} />
            </View>
        </View>
    )
}
