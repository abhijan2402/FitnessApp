...
const ActivityTracker = ({ navigation }) => {
    return (
        <ScreenContainer scroll={true}>
            <SolidContainer containerStyle={styles.solidContainerStyle} onPress={() => { navigation.goBack() }}  >
            ...
            <GradientContainer colors={['rgba(157, 206, 255, 0.2)', 'rgba(157, 206, 255, 0.2)']} styles={{ padding: 20, borderRadius: 20, height: 180, alignItems: "center", height: 430, marginTop: 30 }}>
            ...
            <View style={styles.entrieConteiner} >
                <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                    <ScheduleMealProgress unit={"Kcal"} amount={"1572"} daytime={"Calorie gained"} mealpercentage={"14"} progressbar={{ outerColor: "rgba(157, 208, 48, 0.5)", innerColor: "rgba(157, 208, 48, 1)", percentage: '52' }} />
                    <ScheduleMealProgress unit={"Kcal"} amount={"7548"} daytime={"Calorie Burnt"} mealpercentage={"78"} progressbar={{ outerColor: "rgba(255, 57, 93, 0.5)", innerColor: "rgba(255, 57, 93, 1)", percentage: "70" }} />
                </View>
            </View>
