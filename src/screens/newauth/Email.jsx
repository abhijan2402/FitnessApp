import { ScrollView, StyleSheet, Text, TouchableOpacity, View, Image, Alert, Modal, Pressable } from 'react-native';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={{ alignItems: "center" }}>
        {
          galleryPhoto ?
            ...
            /> :
            <View style={{ borderRadius: 100, borderWidth: 1, padding: 50, backgroundColor: "white" }}>
              {/* <Text>hii</Text> */}
            </View>
        }
      ...
      <View style={{ marginHorizontal: 20 }}>
        ...
        <TextInput
          ...
          onChangeText={(text) => setEmail(text)} style={styles.input} placeholder='email-address' />
        <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
          <TouchableOpacity style={{ width: "45%" }} >
            ...
            <TouchableOpacity onPress={showDatePicker} style={{ backgroundColor: "white" }}>
              <Text style={{ borderWidth: 1, paddingVertical: 14, borderRadius: 10, paddingHorizontal: 15 }}>
                {date}
              </Text>
            </TouchableOpacity>
            {/* <TextInput
        ...
        <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
          <View style={{ width: "30%" }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setWeightVals(text)} style={styles.input} placeholder='Weight' />
          </View>
          <View style={{ width: "30%" }}>
            <SmallText>Goal Weight</SmallText>
            <TextInput
              keyboardType='numeric'
              onChangeText={(text) => setGoalWeightVals(text)} style={styles.input} placeholder='Goal Wei' />
          </View>
          <GradientDropdown
            Tryies={false}
            data={WEIGHT}
          ...
          <View style={styles.centeredView}>
            <View style={[styles.modalView, { height: 180 }]}>
              ...
              <View style={{ display: "flex", flexDirection: "row" }}>
                ...
                <ScrollView style={{ width: 60, height: 100 }} showsVerticalScrollIndicator={false}>
                  {
                    WeiData.map((item, index) => (
                      <Text style={{ paddingVertical: 10, textAlign: "center" }}>{item?.weightVal}</Text>

                    ))
                  }
                </ScrollView>
                <ScrollView style={{ width: 10, height: 100 }} showsVerticalScrollIndicator={false}>
                  {
                    ["kg", "lbs"].map((item, index) => {
                      return (
                        <Text style={{ paddingVertical: 10, textAlign: "center" }}>{item}</Text>
                      )
                    })
                  }
                </ScrollView>
              </View>
              <Pressable style={{ alignSelf: "flex-end", marginHorizontal: 30 }} onPress={() => { setModalVisible(false) }}>
                <Text style={{ fontSize: 15, color: "green", fontWeight: "600" }}>DONE</Text>
              </Pressable>
              {/* <Pressable
